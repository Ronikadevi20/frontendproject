...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios.post('VITE_API_URL=https:/encryptease-backend-production.up.railway.app/api/auth/login', {
  ...
  const handleOtpVerify = async (code: string) => {
    ...
    try {
      // Direct Axios call instead of using authApi
      const response = await axios.post('VITE_API_URL=https:/encryptease-backend-production.up.railway.app/api/auth//verify-login-otp', {
        email: formData.email,
        otp_code: code
      });
